...
export default function TalkToGPCTA({ context }: TalkToGPCTAProps) {
  return (
    <div className="bg-[#434343] rounded-2xl mt-10 text-white overflow-hidden">
      {/* Yellow accent bar */}
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 bg-[#E7D549] text-[#434343] hover:bg-[#d4c43e] font-semibold px-5 py-2.5 rounded-lg text-sm transition-colors"
            >
