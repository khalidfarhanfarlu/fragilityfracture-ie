...
const resultConfig = {
  low: {
    ...
    cta: "If your circumstances change or you have any concerns, speak to your doctor about your bone health.",
  },
  moderate: {
    label: "Moderate Risk — Worth Discussing with Your Doctor",
    bg: "bg-amber-50",
    ...
    advice:
      "While this quiz is not a diagnosis, a moderate number of risk factors means it would be worth raising the topic with your doctor. They can assess your full picture and, if appropriate, arrange a DXA bone density scan — a quick, painless X-ray that measures bone strength.",
    cta: "We recommend mentioning your bone health to your doctor at your next visit, or sooner if you are concerned.",
  },
  high: {
    label: "Higher Risk — Please Speak to Your Doctor",
    bg: "bg-red-50",
    ...
    advice:
      "This quiz is not a medical diagnosis, but your responses indicate that a conversation with your doctor about bone health is strongly recommended. A DXA scan can give a definitive picture of your bone density, and effective treatments are available if needed. Early detection makes a real difference.",
    cta: "Please speak to your doctor about bone density testing. Don't wait for a fracture to find out.",
  },
};
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-slate-50 border border-[#e0e0e0] rounded-xl p-5 text-sm text-[#666666] leading-relaxed">
          ...
          <p>
            ...
            factors. Always consult your doctor or a qualified healthcare professional for
            personalised advice.
          </p>
        </div>
      </div>
