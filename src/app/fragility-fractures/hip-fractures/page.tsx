...
export default function HipFracturesPage() {
  return (
    <PageLayout
      ...
      gpCTAContext="If you or a family member have had a hip fracture, ensure that bone density assessment and secondary fracture prevention treatment are arranged before or after discharge. Ask the hospital team or your doctor."
    >
