...
export default function TypesOfFragilityFracturesPage() {
  return (
    <PageLayout
      ...
      gpCTAContext="If you have had any fracture from a low-energy impact, please discuss this with your doctor — it should prompt an assessment of your bone density regardless of your age."
    >
