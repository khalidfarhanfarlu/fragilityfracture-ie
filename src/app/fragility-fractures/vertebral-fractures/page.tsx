...
export default function VertebralFracturesPage() {
  return (
    <PageLayout
      ...
      gpCTAContext="If you have persistent back pain, loss of height, or a stooped posture — especially if you have risk factors for osteoporosis — speak to your doctor. You may have a vertebral fracture that has not been diagnosed."
    >
      ...
      <p>
        If your doctor suspects a vertebral fracture, they will arrange appropriate imaging. If you are having a DXA scan,
      ...
      <p>
        ...
        this with your doctor — particularly if you have known osteoporosis or risk factors.
      </p>
    </PageLayout>
  );
}
