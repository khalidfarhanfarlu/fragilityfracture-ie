...
export default function RecoveryRehabPage() {
  return (
    ...
    >
      ...
      <p>
        Ask your GP or hospital team for a referral to physiotherapy as soon as possible after your fracture. In many
      ...
      <div className="bg-teal-50 border border-teal-200 rounded-xl p-6 my-6">
        ...
        <ul className="space-y-2 text-sm text-teal-900">
          ...
          <li>&#x2714;&nbsp; Coordinates with GP for ongoing monitoring</li>
        </ul>
      </div>
      ...
      <ul>
        ...
        <li>Contact your GP after discharge to arrange a bone density assessment and discuss osteoporosis treatment</li>
      ...
      <p>
        OT referrals can be arranged through your GP or hospital team. In Ireland, occupational therapy services are
