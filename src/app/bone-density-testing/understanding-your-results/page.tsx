...
export default function UnderstandingResultsPage() {
  return (
    <PageLayout
      ...
      gpCTAContext="Always discuss your DXA results with your GP. They will consider your full clinical picture — including your age, risk factors, and fracture history — to decide whether treatment or lifestyle changes are needed."
    >
      <h1 className="text-4xl font-extrabold text-slate-900 mb-6">Understanding Your DXA Scan Results</h1>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            <tr className="bg-emerald-50">
              ...
              <td className="px-5 py-4 text-slate-700">Bone density is within the normal range. Maintain bone health with good nutrition and exercise.</td>
            </tr>
            <tr className="bg-yellow-50">
              ...
              <td className="px-5 py-4 text-slate-700">Bone density is below normal but not classified as osteoporosis. Lifestyle measures and monitoring are recommended.</td>
            </tr>
            <tr className="bg-orange-50">
              ...
              <td className="px-5 py-4 text-slate-700">Bone density is significantly reduced. Treatment is usually recommended. Your GP will advise.</td>
            </tr>
            <tr className="bg-red-50">
              ...
              <td className="px-5 py-4 text-slate-700">Osteoporosis with one or more fragility fractures. Prompt treatment and secondary prevention are essential.</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p>
        ...
        can prompt your GP to investigate for <strong>secondary causes</strong> of bone loss — such as coeliac
      ...
      <p>
        ...
        and a healthy lifestyle. Your GP may recommend a repeat DXA scan in 2–5 years depending on your risk factors.
      </p>

      <h3>If Your Result Shows Osteopenia</h3>
      <ul>
        <li>Discuss your lifestyle and diet with your GP</li>
        ...
        <li>Your GP may calculate your FRAX score to assess whether medication is appropriate</li>
      </ul>

      <h3>If Your Result Shows Osteoporosis</h3>
      <ul>
        <li>Your GP will discuss treatment options, which will likely include medication</li>
        <li>Ensure adequate calcium and Vitamin D intake (your GP may recommend supplements)</li>
