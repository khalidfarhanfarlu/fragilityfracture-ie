...
export default function FraxToolPage() {
  return (
    <PageLayout
      ...
      gpCTAContext="Your FRAX score should be interpreted by your doctor alongside other clinical information. Discuss your result at your next appointment."
    >
      ...
      <p>
        Print or save your results and bring them to your next doctor appointment. Your doctor can use your FRAX score
      ...
      <p>
        FRAX complements but does <strong>not replace</strong> a DXA scan. Used together, they give your doctor the most
