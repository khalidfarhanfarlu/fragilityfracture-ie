...
const pages = [
  ...
  },
  {
    ...
    desc: "doctor referral pathways, public and private options, and what to bring to your appointment.",
...
export default function BoneDensityTestingPage() {
  return (
    ...
    >
      <h1 className="text-4xl font-extrabold text-[#434343] mb-4">Bone Density &amp; Testing</h1>
      ...
      <div className="mt-10 bg-[#F9F9F9] border border-[#e0e0e0] rounded-xl p-6">
        <p className="text-[#434343] text-sm">
          ...
          to see which factors might make a DXA scan worthwhile for you, then speak to your doctor.
        </p>
      </div>
    </PageLayout>
  );
