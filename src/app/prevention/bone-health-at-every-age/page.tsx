...
const stages = [
  ...
  },
  {
    ...
    actions: ["Continue or increase exercise", "Review calcium and Vitamin D intake", "Discuss bone health at doctor check-ups", "Be aware of perimenopausal changes"],
  },
  {
    ...
    content: [
      ...
      "A DXA scan should be discussed with your doctor, particularly if you have additional risk factors or have experienced early menopause.",
      "Hormone replacement therapy (HRT) is protective for bone density and is sometimes used for this purpose, as well as for managing menopausal symptoms — discuss with your doctor.",
      "This is also the time when wrist fractures most commonly occur — often a first signal of underlying bone density issues.",
    ],
    actions: ["Discuss DXA scan with your doctor", "Consider HRT discussion with your doctor", "Intensify exercise, especially strength training", "Optimise calcium and Vitamin D", "Review family history and risk factors"],
  },
  {
    ...
    content: [
      ...
      "Regular DXA monitoring is recommended. If you have not had a DXA scan by your mid-60s, ask your doctor.",
  ...
  },
  {
    ...
    content: [
      ...
      "Hip protector garments may be considered for those at very high fall risk — discuss with your doctor or physio.",
    ],
...
export default function BoneHealthAtEveryAgePage() {
  return (
    <PageLayout
      ...
      showGPCTA={true}
      gpCTAContext="Whatever your age, it is never too early or too late to discuss your bone health with your doctor. Book an appointment to talk about your individual risk and what you can do."
    >
