...
export default function WhatIsAFragilityFracturePage() {
  return (
    ...
    >
      ...
      <p>
        Your GP can arrange a <a href="/bone-density-testing/what-is-a-dxa-scan">DXA scan</a> to assess your bone
      ...
      <p>
        ...
        receive appropriate assessment and treatment. If you have had a fracture, ask your hospital team or GP whether
