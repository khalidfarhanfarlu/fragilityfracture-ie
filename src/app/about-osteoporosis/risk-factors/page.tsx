...
const modifiable = [
  ...
  { factor: "Long-term corticosteroid use", detail: "Medicines like prednisolone, taken for 3+ months, significantly reduce bone density. Never stop without doctor advice." },
];
...
export default function RiskFactorsPage() {
  return (
    <PageLayout
      ...
      gpCTAContext="If you recognise several risk factors that apply to you, speak to your doctor. They can assess your risk and arrange a bone density (DXA) scan if appropriate."
    >
      ...
      <p>These are factors you cannot change, but knowing about them helps you and your doctor assess your overall risk.</p>
      ...
      <p>
        ...
        following, make sure your doctor is aware and discuss whether bone density monitoring is appropriate for you:
      </p>
      <ul>
      ...
      <p>
        ...
        If you take any of these, do not stop without speaking to your doctor, but do ask about bone health monitoring.
      </p>
      ...
      <p>
        ...
        osteoporotic fracture. Your doctor may use it alongside a DXA scan to guide decisions about treatment.
      </p>
      <p>
