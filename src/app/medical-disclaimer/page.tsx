    ...
    >
      ...
      <div className="bg-amber-50 border border-amber-300 rounded-2xl p-6 mb-8">
        ...
        <p className="text-amber-800">
          ...
          diagnosis, or treatment. Always seek the advice of your GP or another qualified healthcare provider with
      ...
      <h2>Contact Your GP</h2>
      <p>
        If you have any concerns about your bone health, have experienced a fracture, or have questions about
        osteoporosis, the most important thing you can do is speak to your GP. A brief GP consultation is the
