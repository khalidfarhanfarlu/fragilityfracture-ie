...
export const posts: Post[] = [
    ...
    Content: () => (
      <>
        ...
        <p>
          ...
          risk with a doctor. They are, in the language of public health, &ldquo;undetected cases&rdquo; — people
        ...
        <p>
          ...
          another &ldquo;silent&rdquo; condition, is routinely screened at doctor&apos;s surgeries without patients needing
          to request it. Osteoporosis, by contrast, requires a specific referral for a specific scan — and that
          referral only happens if someone thinks to ask, and if the doctor judges it appropriate.
        </p>
        <p>
          In many cases, neither the patient nor the doctor raises bone health as a priority. Patients do not know
        ...
        <p>
          ...
          is, what their risk factors are, and what to ask their doctor. The evidence is clear: awareness drives
        ...
        <p>
          ...
          your doctor about your bone health. Ask specifically whether a DXA scan (bone density test) would be
    ...
    Content: () => (
      <>
        ...
        <p>
          ...
          told only to return to their doctor &ldquo;if needed&rdquo;.
        </p>
        ...
        <p>
          ...
          density scan or a discussion about osteoporosis with your doctor, please take this as your prompt to
          act. You can ask your doctor specifically:
        </p>
        <ul>
        ...
        <p>
          ...
          Use it. Ask the questions. Start the conversation with your doctor. Give yourself the chance to prevent
...

  {
    ...
    Content: () => (
      <>
        <p>
          Ask an Irish doctor what single nutritional supplement they most commonly recommend, and the answer,
        ...
        <ul>
          ...
          <li>If you are over 65, housebound, or have osteoporosis, discuss whether a higher dose is appropriate with your doctor</li>
